...
const floatingButtonClassName =
  'fixed right-5 bottom-10 flex h-14 w-14 cursor-pointer items-center justify-center rounded-full border-[2.5px] border-white/40 bg-blue-500 shadow-[0_8px_12px_0_var(--color-grey-100)] transition-colors hover:bg-[linear-gradient(0deg,rgba(0,119,204,0.3)_0%,rgba(0,119,204,0.3)_100%),var(--color-blue-500)] active:bg-[linear-gradient(0deg,rgba(0,119,204,0.3)_0%,rgba(0,119,204,0.3)_100%),var(--color-blue-500)] disabled:cursor-not-allowed disabled:opacity-50';
